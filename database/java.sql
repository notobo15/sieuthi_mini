...
-- Script date 3/4/2023 8:32:25 AM
...
REFERENCES groups (group_id) ON DELETE NO ACTION;
...
-- Create foreign key
--
ALTER TABLE import_mst
ADD CONSTRAINT FK_import_mst_suppilier_id FOREIGN KEY (suppilier_id)
...
--
ALTER TABLE import_mst
ADD CONSTRAINT FK_import_mst_warehouse_id FOREIGN KEY (warehouse_id)
REFERENCES warehouse (warehouse_id) ON DELETE NO ACTION;
...
ADD CONSTRAINT FK_import_detail_import_mst_id FOREIGN KEY (import_mst_id)
REFERENCES import_mst (import_mst_id) ON DELETE NO ACTION;
...
ADD CONSTRAINT FK_group_permission_group_id FOREIGN KEY (group_id)
REFERENCES groups (group_id) ON DELETE NO ACTION;
...
--
ALTER TABLE group_permission
ADD CONSTRAINT FK_group_permission_permission_id FOREIGN KEY (permission_id)
REFERENCES permission (per_id) ON DELETE NO ACTION;
